...
/**
 * Interface for data storage in the database. Provides methods for creating,
 * reading, updating, deleting and listing objects.
 *
...
public interface Dao<T, K> {
     ...
     * @throws SQLException if object to be added does not represent the T
     * entity
     */
